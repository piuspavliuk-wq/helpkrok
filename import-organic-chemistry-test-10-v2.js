...
async function importOrganicChemistryTest10V2() {
  try {
    console.log('🚀 Початок тестового імпорту питань з органічної хімії v2 (10 питань)...');
    ...
    console.log('🎉 Тестовий імпорт v2 завершено успішно!');
...
importOrganicChemistryTest10V2();
