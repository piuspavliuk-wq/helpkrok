...
// Конфігурація для тесту "2025 лютий"
const testConfig = {
  year: 2025,
  identifier: '2025-pharmacy-february',
  title: '2025 лютий',
  timerSeconds: 30 // 30 секунд
};

class Pharmacy2025FebruaryScraper {
...
async function run2025FebruaryScraper() {
  console.log('🚀 ЗАПУСКАЄМО СКРАПЕР ДЛЯ "2025 лютий" З ТАЙМЕРОМ 30 СЕКУНД...');
  console.log('');
  
  const scraper = new Pharmacy2025FebruaryScraper(testConfig);
...
if (require.main === module) {
  run2025FebruaryScraper().catch(console.error);
}

module.exports = { Pharmacy2025FebruaryScraper, run2025FebruaryScraper };
