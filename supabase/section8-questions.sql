-- SQL для додавання питань до розділу 8: Новоутвореня
-- Автоматично згенеровано
-- Кількість питань: 168
...
BEGIN
  ...
  -- Створюємо або знаходимо topic для розділу 8
  SELECT id INTO v_topic_id
  FROM topics
  WHERE course_id = v_course_id AND title = 'Новоутвореня'
  LIMIT 1;
  ...
  RAISE NOTICE 'Початок додавання питань для розділу 8...';
  ...
  VALUES (
    v_topic_id,
    'У шматочку шкіри 1х2 см, що доставлений для гістологічного дослідження, знайдено новоутворення бурого кольору діаметром 0,5 см. Під час мікроскопічного дослідження виявлено, що пухлина складається з клітин у вигляді тяжів та гнізд, розташованих у дермі, з бурим пігментом у цитоплазмі, що дає негативну реакцію Перлса. Який пігмент виявлено у цьому випадку?',
    'medium',
    0,
    true,
    NOW(),
  ...
  VALUES (
    v_question_id,
    'Зміни інтими за типом "шагреневої шкіри"',
    false,
    1,
    NOW(),
    NOW()
  ...
  VALUES (
    v_topic_id,
    'У молодої людини в м''яких тканинах лівого стегна з''явилось безболісне новоутворення без чітких меж. У біоптаті тканини новоутворення нагадують риб''яче м''ясо, складаються з незрілих фібробластоподібних клітин з численними мітозами, проростають в м''язи. Який найбільш ймовірний діагноз?',
    'medium',
    6,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'При обстеженні хворого виявлено новоутворення в білому речовині півкуль великого мозку з локалізацією в коліні і передньому відділі задньої ніжки внутрішньої капсули. Волокна якого провідного шляху мозку будуть зруйновані?',
    'medium',
    7,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'У жінки віком 47 років для дослідження отримано біопсію слизової оболонки бронха. Під час гістологічного дослідження виявлено тяжі атипових клітин епітелію, які вростають у підлеглу тканину. У центрі тяжів виявлено концентричні утворення рожевого кольору «ракові перлини». Який вид пухлини виявив лікар?',
    'medium',
    8,
    true,
    NOW(),
  ...
  VALUES (
    v_question_id,
    'Плоскоклітинний рак з зроговінням',
    true,
    1,
    NOW(),
    NOW()
  ...
  VALUES (
    v_topic_id,
    'В біоптаті бронха хворого, який зловживає курінням, з потовщеною слизовою оболонкою виявлено хронічне запалення і трансформацію одношарового війчастого епітелію в багатошаровий плоский епітелій. Який з процесів найбільш вірогідний?',
    'medium',
    18,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'При мікроскопічному дослідженні біоптата з товстої кишки виявлена пухлина з призматичного епітелію, що формує атипові залозисті структури різної форми й величини. Базальна мембрана залоз зруйнована. Клітки пухлини поліморфні, ядра гіперхромні, відзначається велика кількість патологічних мітозів. Який діагноз найбільш імовірний?',
    'medium',
    22,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Чоловік віком 69 років скаржиться на прогресуючу асиметрію обличчя, парез мімічних м''язів обличчя. Під час огляду виявлено новоутворення в привушній ділянці праворуч попереду мочки вуха без чітких меж, до 7 см у діаметрі, спаяне з прилеглими тканинами. Який попередній діагноз?',
    'medium',
    23,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Молода жінка звернулася до лікаря- гінеколога зі скаргами на тривалі маткові кровотечі. Виконано вишкрібання порожнини матки. Отримана пухка маса, що складається з тонкостінних напівпрозорих кістозних структур. Під час мікроскопічного дослідження виявлено: ворсини хоріона, частина з яких різко розширена за рахунок гідропічного набряку, з вогнищевою проліферацією цитотрофобласту і синцитіотрофобласту. Який діагноз може запідозрити лікар?',
    'medium',
    25,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Пацієнтка оперована з приводу пухлини матки. Макропрепарат - губчастий строкатий вузол у міометрії. Гістологічно виявлено: великі світлі епітеліальні клітини, серед яких багато темних поліморфних клітин. Строма відсутня, судини мають вигляд порожнин, вистелених клітинами пухлини. Визначаються множинні крововиливи. Як називається виявлена пухлина?',
    'medium',
    27,
    true,
    NOW(),
  ...
  VALUES (
    v_question_id,
    'Деструюючий (злоякісний) міхурцевий занесок',
    false,
    0,
    NOW(),
    NOW()
  ...
  VALUES (
    v_topic_id,
    'У 18-річної дівчини через рік після видалення дермоїдної кісти лівого яєчника і клиноподібної резекції правого яєчника, зʼявився утвір у малому тазу діаметром 15,0 см. Під час термінового інтраопераційного дослідження виявлена пухлина кістозно-солідної будови мʼякої консистенції з безліччю кіст різного розміру, частина з яких заповнена мутним геморагічним вмістом. При мікроскопічному дослідженні в стінці кісти і солідних ділянках знайдено зрілі ембріональні структури декількох типів тканин і незрілу гліозну тканину. Який найбільш імовірний діагноз було встановлено при дослідженні пухлини?',
    'medium',
    28,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Під час гістологічного дослідження пухлини шкіри виявлено різних розмірів часточки з жирової тканини, відмежовані нерегулярними прошарками сполучної тканини. Якому захворюванню відповідають такі патологічні зміни?',
    'medium',
    29,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Артеріальна гіпертензія в жінки віком 44 роки зумовлена наявністю феохромоцитоми — пухлини мозкового шару наднирників. Антигіпертензивні засоби якої групи найдоцільніше буде при- значити?',
    'medium',
    30,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'На розтині тіла чоловіка, 55 років, виявлено потовщення стінки шлунка до 1,2 см, слизова оболонка нерухома, її складки не визначаються. На розрізі тканина однорідна, білувата, хрящоподібної щільності. Для якої макроскопічної форми пухлини характерні описані зміни?',
    'medium',
    31,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'У жінки 35-ти років проведено біопсію вузлових утворень молочної залози. В ході гістологічного дослідження відзначається посилена проліферація епітелію дрібних протоків та ацинусів з формуванням залозистоподібних структур, різної форми та розмірів, які розташовані у фіброзній стромі. У ділянках залозистої проліферації ознак клітинної атипії не виявлено. Який найбільш імовірний діагноз?',
    'medium',
    37,
    true,
    NOW(),
  ...
  VALUES (
    v_question_id,
    'Ацидофільна аденома з малігнізацією',
    false,
    2,
    NOW(),
    NOW()
  ...
  VALUES (
    v_topic_id,
    'Жінці віком 26 років проведено ургентне оперативне втручання в об’емі: Видалення лівої маткової труби. Під час огляду маткова труба розширена, заповнена геморагічним вмістом. Під час гістологічного дослідження знайдені хоріальні ворсини, розростання децидуальної тканини, великі поля еритроцитів. Який патологічний стан виник?',
    'medium',
    45,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'У пацієнта зі встановленим діагнозом: СНІД - на нижній кінцівці виявлено пухлину, що злегка підіймається над шкірою, є безболісні плями. Гістологічно для видаленої пухлини характерні незавершений ангіогенез, проліферація веретеноподібних клітин, що утворюють пучки, які хаотично переплітаються, і розростання грануляційної тканини різного ступеня зрілості з інфільтрацією імунокомпетентними клітинами. Васкулярні проліферати оточені набряклою рихлою сполучною тканиною, наявні відкладення гемосидерину. Який найімовірніший діагноз?',
    'medium',
    46,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'У чоловіка віком 75 років із заочеревинної клітковини видалено пухлину розміром 16,0х8,0х6,5 см. Мікроскопічно виявлено анаплазовані клітини з вираженими ознаками атипізму, поліморфізму та мітотичної активності, іноді спостерігаються великі спотворені клітини з суданофільними вакуолями в цитоплазмі. Для якого захворювання характерні такі результати дослідження?',
    'medium',
    48,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'У пацієнтки віком 64 роки виник патологічний перелом плечової кістки. Під час біопсії виявлено атипові плазматичні клітини. Рентгенологічно в місці перелому спостерігаються пухлиноподібні утворення. Якому захворюванню відповідають такі патологічні зміни?',
    'medium',
    51,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Під час операції видалення матки з яєчниками і матковими трубами лікар перев’язує зв’язку, що підвішує яєчник. Які судини перев’язав лікар в цій зв’язці?',
    'medium',
    56,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'У хворого з неврологічними порушеннями діагностована пухлина головного мозку. Під час операції видалена пухлина, що має вид щільного вузла, пов’язаного з твердою мозковою оболонкою. Гістологічно пухлина побудована з ендотеліоподібних клітин, тісно прилеглих одна до одної. Який найбільш імовірний діагноз?',
    'medium',
    58,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'В експерименті показано, що при саркомі Ієнсена споживання глюкози з привідної до пухлини артерії значно збільшується, має місце також приріст вмісту молочної кислоти у відвідній вені. Про що свідчить дане явище?',
    'medium',
    66,
    true,
    NOW(),
  ...
  VALUES (
    v_question_id,
    'Посилення анаеробного гліколізу',
    true,
    0,
    NOW(),
    NOW()
  ...
  VALUES (
    v_question_id,
    'Зменшення анаеробного гліколізу',
    false,
    4,
    NOW(),
    NOW()
  ...
  VALUES (
    v_topic_id,
    'Хвора 75-ти років доставлена до офтальмологічного відділення лікарні зі скаргами на погіршення зору. При об’єктивному дослідженні встановлена наявність пухлини мозку, що розташована в ділянці лівого зорового тракту. При цьому у хворої спостерігається випадіння поля зору в:',
    'medium',
    67,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'У хворого 39 років після променевої терапії з приводу пухлини печінки утворилася виразка тонкої кишки внаслідок пригнічення мітотичної активності клітин, за рахунок яких відбувається поновлення покривного епітелію тонкої кишки. Мітотичну активність яких клітин пригнічено у даного хворого?',
    'medium',
    71,
    true,
    NOW(),
  ...
  VALUES (
    v_question_id,
    'Екзокриноцитів з ацидофільною зернистістю',
    false,
    1,
    NOW(),
    NOW()
  ...
  VALUES (
    v_question_id,
    'Стовпчастих клітин крипт без облямівки',
    true,
    2,
    NOW(),
    NOW()
  ...
  VALUES (
    v_topic_id,
    'У хворого 60 років унаслідок злоякісної пухлини великого сосочка дванадцятипалої кишки виникла обтураційна жовтяниця. Просвіт якої анатомічної структури стискується пухлиною?',
    'medium',
    72,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'При мікроскопічному дослідженні пухлини верхньої губи виявлено, що вона побудована з численних щілиноподібних порожнин. Стінки порожнин вистелені плоским ендотелієм. Порожнини заповнені рідкою кров''ю і згустками. Поставте діагноз.',
    'medium',
    74,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Під час розтину тіла чоловіка у віці 63 років, який помер від раку легені, були виявлені множинні метастази. Які з них можна розцінити як імплантаційні (контактні) за механізмом розвитку?',
    'medium',
    75,
    true,
    NOW(),
  ...
  VALUES (
    v_question_id,
    'Дрібні множинні пухлинні вузлики на плеврі',
    true,
    1,
    NOW(),
    NOW()
  ...
  VALUES (
    v_question_id,
    'Проростання пухлини з бронху в стравохід',
    false,
    2,
    NOW(),
    NOW()
  ...
  VALUES (
    v_question_id,
    'Гіперплазія еритроїдного відростка пухлинної природи',
    true,
    4,
    NOW(),
    NOW()
  ...
  VALUES (
    v_topic_id,
    'На культуру пухлинних клітин подіяли колхіцином, який блокує утворення білків-тубулінів, що утворюють веретено поділу. Які етапи клітинного циклу порушаться?',
    'medium',
    79,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'У жінки віком 37 років виявлено: пухлина розмірами Зх4 см, на 1 см нижче місця входження стравоходу до шлунка. Яка частина шлунка уражена пухлною?',
    'medium',
    81,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Під час рентгенологічного обстеження виявлено збільшення розміру турецького сідла внаслідок пухлиноподібного утворення головного мозку Яка частина головного мозку зазнала патологічних змін?',
    'medium',
    82,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Установлено, що за витрати тієї самої кількості глюкози пухлинна тканина отримує енергії в 20-25 разів менше, ніж здорова. Про яку зміну метаболізму глюкози в пухлині свідчить це явище?',
    'medium',
    84,
    true,
    NOW(),
  ...
  VALUES (
    v_question_id,
    'Посилення окислювальних процесів',
    false,
    1,
    NOW(),
    NOW()
  ...
  VALUES (
    v_question_id,
    'Нормальне співвідношення цих процесів',
    false,
    2,
    NOW(),
    NOW()
  ...
  VALUES (
    v_question_id,
    'Послаблення анаеробного дихання',
    false,
    4,
    NOW(),
    NOW()
  ...
  VALUES (
    v_topic_id,
    'Під час гістологічного дослідженні пухлини шкіри виявлені різних розмірів часточки з жирової тканини, відмежовані нерегулярними прошарками сполучної тканини. Якому захворюванню відповідають такі патологічні зміни?',
    'medium',
    86,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Жінка віком 67 років хворіє на рак шлунку з метастазами в печінці. Яка властивість пухлинних клітин обумовлює їх здатність до метастазування?',
    'medium',
    88,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'У дитини 10 років, через виявлену пухлину, видалено задню частку гіпофіза. Унаслідок цього виникне:',
    'medium',
    90,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'У пацієнта віком 50 років зі скаргами на втрату маси тіла та слабкість у крові виявлені гіпоглікемія і гіперінсулінемія. Під час додаткового обстеження виявлено пухлину острівців Лангерганса. Наслідком якого атипізму клітин є посилення синтезу інсуліну в цьому разі?',
    'medium',
    93,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'При розтині тіла дитини 3-х років у мозочку виявлена пухлина, що не має чітких меж з оточуючою тканиною, гістологічно побудована з атипових дрібних клітин з гіперхромними ядрами. Найвірогідніше це:',
    'medium',
    98,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'У хворого пухлина підшлункової залози. При хірургічному втручанні доступ проведений шляхом розтину lig. gastrocolicum. При цьому випадково травмована судина, що проходить у даній зв''язці. Кровотечу з якої судини був змушений зупиняти хірург?',
    'medium',
    100,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'У пацієнта з тимомою (пухлиною вилочкової залози) об''єктивно спостерігається: ціаноз, розширення підшкірної венозної сітки, набряк м''яких тканин обличчя, шиї, верхньої половини тулуба і верхніх кінцівок. Який венозний стовбур стиснений пухлиною?',
    'medium',
    103,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'У чоловіка спостерігається пухлина черевної порожнини, що здавлює нижню порожнисту вену. Який кава-кавальний анастомоз на передній стінці живота забезпечить відтік венозної крові?',
    'medium',
    104,
    true,
    NOW(),
  ...
  VALUES (
    v_question_id,
    'Між верхньою і нижньою надчеревними венами',
    true,
    0,
    NOW(),
    NOW()
  ...
  VALUES (
    v_question_id,
    'Між пупковою і верхньою надчеревною венами',
    false,
    1,
    NOW(),
    NOW()
  ...
  VALUES (
    v_question_id,
    'Між непарною і напівнепарною венами',
    false,
    2,
    NOW(),
    NOW()
  ...
  VALUES (
    v_question_id,
    'Між хребетними і пупковими венами',
    false,
    3,
    NOW(),
    NOW()
  ...
  VALUES (
    v_question_id,
    'Між верхніми і нижніми прямокишковими венами',
    false,
    4,
    NOW(),
    NOW()
  ...
  VALUES (
    v_topic_id,
    'З''ясовано, що причиною такого стану пацієнта є гормонально активна пухлина кори наднирників. Гіперпродукція якого гормону є причиною вторинної артеріальної гіпертензії у хворого?',
    'medium',
    105,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'У хворого пухлиною пошкоджено піраміди довгастого мозку. У якому з провідних шляхів порушиться проведення нервових імпульсів?',
    'medium',
    106,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Надмірна секреція певного гормону спостерігалася у хворого при феохромоцитомі - пухлині, що походить з мозкової речовини надниркових залоз. Як він називається?',
    'medium',
    107,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'У жінки діагностовано пухлину головки підшлункової залози, порушення венозного відтоку із деяких органів черевної порожнини. Яка венозна судина була здавлена пухлиною?',
    'medium',
    109,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'В товщі шкіри макроскопічно виявлено рухливу пухлину. Мікроскопічно спостерігаються хаотично розташовані пучки колагенових волокон із невеликою кількістю веретеноподібних клітин. Яка пухлина виявлена?',
    'medium',
    110,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'У жінки, хворої на злоякісну пухлину молочної залози, лікар виявив збільшення регіонарних лімфатичних вузлів. Яка група вузлів підлягає ураженню при даній патології в першу чергу?',
    'medium',
    115,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'В шкірі виявлена щільна, рухома, чітко відмежована від оточуючих тканин пухлина. На розрізі вона білого кольору, представлена волокнистою тканиною. Мікроскопічно: хаотично переплетені колагенові волокна, клітин мало. Що це за пухлина?',
    'medium',
    126,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'У хворої під час профілактичного обстеження на медіальній стінці лівої пахвової западини виявлений збільшений лімфовузол метастатичного походження. Вкажіть найбільш вірогідну локалізацію первинної пухлини:',
    'medium',
    129,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'У положенні на спині дитина 6 місяців задихається. Пальпаторно на передній стінці трахеї до яремної вирізки визначається пухлиноподібне утворення, яке продовжується в переднє середостіння. Що з наведеного може стискати трахею?',
    'medium',
    134,
    true,
    NOW(),
  ...
  VALUES (
    v_question_id,
    'Навколощитоподібні лімфатичні вузли',
    false,
    1,
    NOW(),
    NOW()
  ...
  VALUES (
    v_question_id,
    'Навколотрахеальні лімфатичні вузли',
    false,
    2,
    NOW(),
    NOW()
  ...
  VALUES (
    v_topic_id,
    'Чоловік 63 років страждає на рак стравоходу, є метастази в лімфатичні вузли середостіння, ракова кахексія. Яка патогенетична стадія пухлинного процесу у цьому випадку?',
    'medium',
    135,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'У жінки виявлено пухлину яєчника. Показана операція. Яку зв`язку повинен перерізати хірург, щоб відділити яєчник від матки?',
    'medium',
    136,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Для гістологічного дослідження доставлена віддалена на операції матка. Під слизової оболонкою визначені численні округлої форми вузли, чітко відокремлені від навколишнього тканини. Мікроскопічно пухлина побудована з пучків гладкої мускулатури, з явищами тканинного атипизма. Який найбільш ймовірний діагноз?',
    'medium',
    137,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'У пацієнта на шкірі обличчя поступово виникла бляшка з некрозом і виразкою в центрі. Під час проведення патогістологічного дослідження біоптату виявлено розростання атипових епітеліальних клітин із великою кількістю патологічних мітозів. Для якого захворювання характерні такі прояви?',
    'medium',
    140,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'У пацієнта під час операції виявили пухлину шлунка в первинному вогнищі малігнізації (у межах слизової оболонки). Метастази в лімфатичних вузлах і віддалені метастази відсутні. Який етап розвитку патогенезу пухлини спостерігається у пацієнта?',
    'medium',
    153,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'У жінки після операції видалення ракової пухлини молочної залози та регіонарних лімфовузлів розвинувся набряк руки, який був пов''язаний із лімфатичною недостатністю. Який це вид лімфатичної недостатності за механізмом виникнення?',
    'medium',
    157,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Пацієнту після видалення пухлини для проведення хіміотерапії було призначено 5-фторурацил. Яка особливість дії фторурацилу забезпечує його використання як протипухлинного препарата?',
    'medium',
    158,
    true,
    NOW(),
  ...
  VALUES (
    v_question_id,
    'Він є інгібітором дигідрофолатредуктази',
    false,
    0,
    NOW(),
    NOW()
  ...
  VALUES (
    v_question_id,
    'Він є інгібітором тимідилатсинтази',
    true,
    1,
    NOW(),
    NOW()
  ...
  VALUES (
    v_question_id,
    'Він є інгібітором РНК-полімерази',
    false,
    2,
    NOW(),
    NOW()
  ...
  VALUES (
    v_question_id,
    'Він є активатором РНК-полімерази',
    false,
    3,
    NOW(),
    NOW()
  ...
  VALUES (
    v_topic_id,
    'Артеріальна гіпертензія у жінки 44 років обумовлена наявністю феохромоцитоми - пухлини мозкового шару наднирників. Антигіпертензивні засоби якої групи найдоцільніше буде призначити?',
    'medium',
    165,
    true,
    NOW(),
  ...
  RAISE NOTICE 'Додано питань: 167';
END $$;
