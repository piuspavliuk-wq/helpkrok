-- SQL для додавання питань до розділу 22: Лікарські засоби, що впливають на ЦНС і ПНС
-- Автоматично згенеровано
-- Кількість питань: 226
...
BEGIN
  ...
  FROM topics
  WHERE course_id = v_course_id AND title = 'Лікарські засоби, що впливають на ЦНС і ПНС'
  LIMIT 1;
  ...
  IF v_topic_id IS NULL THEN
    ...
    VALUES (
      v_course_id,
      'Лікарські засоби, що впливають на ЦНС і ПНС',
      'Тести з фармакології ЦНС і ПНС',
      4,
      true,
      NOW(),
      NOW()
  ...
  VALUES (
    v_topic_id,
    'Хворому для купірування порушення серцевого ритму було введено препарат, який також застосовується у якості місцево анестезуючого засобу. Визначте препарат:',
    'medium',
    4,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Для знеболювання маніпуляції, пов''язаної із обробкою опеченої поверхні, ввели внутрішньовенно препарат для короткочасного наркозу. Наркоз настав через хвилину, під час нього спостерігалися підвищення АТ, тахікардія, підвищення тонусу скелетних м''язів; рефлекси збережені. Після виходу із наркозу у хворого відзначалися дезорієнтація, зорові галюцинації. Який препарат ввели хворому?',
    'medium',
    7,
    true,
    NOW(),
  ...
  VALUES (
    v_question_id,
    'Н-холіноблокатори, Н2-гістаміноблокатори',
    false,
    3,
    NOW(),
    NOW()
  ...
  VALUES (
    v_topic_id,
    'Для дослідження очного дна в жінки віком 62 роки було призначено лікарський препарат в очних краплях, який також викликав параліч акомодації і підвищення внутрішньоочного тиску. Укажіть, до якої групи належить призначений препарат.',
    'medium',
    9,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Пацієнта шпиталізовано до приймального відділення зі скаргами на запаморочення, зниження гостроти зору, нудоту, слинотечу та спастичний біль у животі. Встановлено діагноз: отруєння фосфорорганічними сполуками. Що необхідно призначити в складі комплексної терапії?',
    'medium',
    14,
    true,
    NOW(),
  ...
  VALUES (
    v_question_id,
    'Фізико-хімічний антагонізм (антидотизм)',
    false,
    1,
    NOW(),
    NOW()
  ...
  VALUES (
    v_question_id,
    'Прямий функціональний однобічний антагонізм',
    true,
    2,
    NOW(),
    NOW()
  ...
  VALUES (
    v_question_id,
    'Опосередкований функціональний антагонізм',
    false,
    4,
    NOW(),
    NOW()
  ...
  VALUES (
    v_topic_id,
    'Хворому для купірування кишкової коліки призначений атропіну сульфат. Яке з названих захворювань може служити протипоказанням в цьому випадку?',
    'medium',
    22,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Під час огляду пацієнта лікар-офтальмолог застосував краплі, що містять атропін та викликають стійке розширення зіниці. Який м’яз при цьому блокується?',
    'medium',
    26,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Лікар застосував тубокурарину хлорид під час вправлення вивиху в пацієнта. Незабаром з’явилися явища передозування. Який препарат потрібно вибрати для їхнього усунення?',
    'medium',
    29,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Тубокурарину хлорид був застосований під час вправлення вивиху у пацієнта. Незабаром з''явилися явища передозування. Який препарат потрібно вибрати для їхнього усунення?',
    'medium',
    30,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Восьмирічного хлопчика з обтяженим алергологічним анамнезом, хронічна рецидивна кропив’янка, причиною якої є харчові алергени — шпиталізовано у стані анафілактичного шоку після ужалення оси. Об’єктивно спостерігається: холодна, бліда, спітніла шкіра тулуба, ціаноз губ і кінцівок, гіпотензія, тахікардія, свистяче дихання, утрата свідомості. Який із нижченаведених засобів необхідно ввести першочергово?',
    'medium',
    47,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Чоловіка віком 36 років шпиталізовано до відділення інтенсивної терапії з явищами анафілактичного шоку після того, як його вжалила бджола. Який лікарський засіб необхідно призначити в цьому разі?',
    'medium',
    48,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Хвора на бронхіальну астму приймала таблетки, які викликали безсоння, головний біль і підвищення артеріального тиску. Який препарат міг стати причиною таких ускладнень?',
    'medium',
    60,
    true,
    NOW(),
  ...
  VALUES (
    v_question_id,
    'Кардіоселективні В-адреноблокатори',
    false,
    2,
    NOW(),
    NOW()
  ...
  VALUES (
    v_question_id,
    'Неселективні В-адреноблокатори',
    false,
    3,
    NOW(),
    NOW()
  ...
  VALUES (
    v_topic_id,
    'У пацієнта виникли артеріальна гіпертензія, тахіаритмія та стійкі порушення кровообігу серцевого м’яза. Прийом якого засобу доцільно призначити пацієнту з такою патологією?',
    'medium',
    69,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'У пацієнта під час медичного обстеження виявлено стенокардію. Лікар призначив йому препарат метопролол, який знижує силу і частоту серцевих скорочень і, відповідно, потребу міокарда в кисні. Який механізм його лікуючої дії?',
    'medium',
    72,
    true,
    NOW(),
  ...
  VALUES (
    v_question_id,
    'Блокада beta_2-адренорецепторів',
    false,
    0,
    NOW(),
    NOW()
  ...
  VALUES (
    v_question_id,
    'Стимуляція beta_1-адренорецепторів',
    false,
    4,
    NOW(),
    NOW()
  ...
  VALUES (
    v_topic_id,
    'Пацієнт з діагнозом: гіпертонічна хвороба (АТ — 200/110 мм рт. Ст) — серед препаратів комплексної терапії лікар призначив анаприлін (пропранолол). За 2 тижні після початку приймання цього лікарського засобу пацієнт почав скаржитися на задишку та ускладнене дихання. Що є можливою причиною ускладнень і яку тактику потрібно вбрати в цій ситуації ?',
    'medium',
    81,
    true,
    NOW(),
  ...
  VALUES (
    v_question_id,
    'Блокада В1-адренорецепторів. Призначити селективний В2-адреноблокатор',
    false,
    1,
    NOW(),
    NOW()
  ...
  VALUES (
    v_question_id,
    'Міотропна бронхостастична дія, Призначити теофілін',
    false,
    2,
    NOW(),
    NOW()
  ...
  VALUES (
    v_question_id,
    'Блокада В2-адренорецепторів. Призначити селективний В1-адреноблокатор',
    true,
    4,
    NOW(),
    NOW()
  ...
  VALUES (
    v_topic_id,
    'Лікар швидкої допомоги встановив у хворого діагноз гіпертонічний криз. Для усунення цього стану хворому парентерально введено засіб, який крім гіпотензивної має також протисудомну дію, а при ентеральному введенні - проносну і жовчогінну. Назвіть цей препарат:',
    'medium',
    90,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'До приймального відділення доставлено хворого у непритомному стані. Шкіра холодна, зіниці звужені, дихання з утрудненням, відзначається періодичність по типу Чейна-Стокса, артеріальний тиск знижений, сечовий міхур переповнений. Отруєння якою речовиною найбільш вірогідне?',
    'medium',
    98,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Чоловік віком 25 років шпиталізований до відділення інтенсивної терапії. Об''єктивно спостерігається: сонливий, ціаноз шкіри, рідке переривчасте дихання, різке звуження зіниць. Колінні рефлекси збережені. На руках виявлені сліди ін''єкцій. На отруєння яким препаратом вказують наведені симптоми?',
    'medium',
    106,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'У зв’язку з вираженим больовим синдромом хворому призначено наркотичний анальгетик. Вкажіть обраний препарат:',
    'medium',
    109,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'В приймальне відділення доставлений чоловік у непритомному стані. Об''єктивно: на зовнішні подразники хворий НЕ реагує, дихання періодичне по типу Чейна - Стокса, зіниці звужені, зіничний рефлекс відсутній. Було встановлено, що дані симптоми обумовлені використанням морфіну. Призначити антидотну терапію.',
    'medium',
    121,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Показом для наркотичних анальгетиків (морфін, тримеперидин) слугує тільки гострий сильний біль, який загрожує життю пацієнта. У зв’язку з чим вищенаведена група ліків має такі обмежені показання до практичного застосування?',
    'medium',
    128,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'До реанімаційного відділення надійшов хворий з ознаками гострого отруєння морфіном. Який засіб необхідно використати у даному випадку для промивання шлунку?',
    'medium',
    132,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Пацієнта шиталізовано до хірургічного відділення для оперативного втручання. Йому необхідно провести нейролептаналгезію. Який із препаратів застосовують в анестезіології у комбінації з фентанілом для нейролептаналгезії?',
    'medium',
    137,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Породіллі з патологією вагітності необхідно медикаментозне знеболення пологів. Який препарат можна призначити?',
    'medium',
    142,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'До відділення реанімації госпіталізовано пацієнта із діагнозом: інфаркт міокарда. Який лікарський засіб треба ввести пацієнту для купірування больового синдрому?',
    'medium',
    146,
    true,
    NOW(),
  ...
  VALUES (
    v_question_id,
    'Переважаюче пригнічення циклооксигенази-1',
    false,
    2,
    NOW(),
    NOW()
  ...
  VALUES (
    v_question_id,
    'Переважаюча стимуляція аденіла-тциклази',
    false,
    3,
    NOW(),
    NOW()
  ...
  VALUES (
    v_topic_id,
    'У пацієнта з хронічним гіперацидним гастритом зʼявився біль у суглобах. Для полегшення болю, ураховуючи супутню патологію, був призначений целекоксиб. Вибіркова дія цього препарату на певний фермент забезпечує відсутність впливу на слизову оболонку шлунка. Укажіть цей фермент.',
    'medium',
    151,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Пацієнтці зі скаргами на швидку стомлюваність і біль у суглобах після біохімічного обстеження встановлено діагноз: гостра ревматична гарячка. Лікарка призначила целекоксиб. Який механізм дії цього препарату?',
    'medium',
    152,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Пацієнту для гамування зубного болю лікар призначив анальгетик, в якого відсутній подразнювальний вплив на оболонку травного каналу, а також ульцерогенний ефект. Укажіть цей лікарський засіб.',
    'medium',
    156,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'До інфекційного відділення госпіталізували пацієнта з гострим респіраторним вірусним захворюванням і температурою тіла 39,5^oC) Який жарознижувальний препарат доцільно призначити?',
    'medium',
    157,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Для зменшення суглобового болю пацієнтка прийняла одночасно по таблетці парацетамолу та диклофенаку натрію. Який вид взаємодії ліків використала пацієнтка для самолікування?',
    'medium',
    158,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Жінка 28-ми років звернулася в поліклініку зі скаргами на головний біль. Лікар запропонував їй парацетамол, взявши до уваги наявність соматичного захворювання. Яка супутня хвороба зробила необхідним призначення саме парацетамолу?',
    'medium',
    160,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Хворий 38 років, який страждає на шизофренію, тривалий час перебував на лікуванні психотропними засобами. Він звернувся до лікаря зі скаргами на порушення координації рухів, тремор рук, сонливість. Яка група препаратів може викликати такий симптомокомплекс?',
    'medium',
    162,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'У другій половині вагітності жінка приймала транквілізатори груп бензодіазепінів. Пологи наступили в термін, протікали нормально, але народилася дитина з численними аномаліями розвитку (заяча губа, полідактилія). Як називається описана дія препарату?',
    'medium',
    166,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'У хворої 45-ти років невроз, що проявляється дратівливістю, безсонням, немотивованою тривогою. Який лікарський засіб усуне всі симптоми?',
    'medium',
    172,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Жінці віком 28 років зі скаргами на тривогу страх, невпевненість у собі, психічне напруження лікар-психіатр призначив діазепам. Який механізм його транквілізуючої дії?',
    'medium',
    173,
    true,
    NOW(),
  ...
  VALUES (
    v_question_id,
    'Взаємодія з гістаміновими рецепторами',
    false,
    0,
    NOW(),
    NOW()
  ...
  VALUES (
    v_topic_id,
    'Трирічну дитину шпиталізовано з приводу випадкового прийому діазепаму. Який із нижченаведених лікарських засобів потрібно призначити для усунення дії бензодіазепінового анксіолітика разом із загальною підтримувальною терапією?',
    'medium',
    174,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Для забезпечення анальгезії наркоємний анальгетик застосували разом з препаратом бензодіазепінового ряду. Який лікарський засіб треба використати для потенціювання анальгезії?',
    'medium',
    178,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'У 50-х роках у Західній Європі від матерів, які приймали в якості снодійного талідоміл, народилося кілька тисяч дітей з відсутністю або недорозвиненням кінцівок, порушенням будови скелета, іншими вадами. Яка природа даної патології?',
    'medium',
    181,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Під час лабораторного дослідження жінки віком 18 років виявлено порушення обміну мелатоніну. Це може бути пов’язано з нестачею амінокислоти, з якої мелатонін синтезується. Укажіть цю амінокислоту.',
    'medium',
    193,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'В організмі людини визначено порушення обміну мелатоніну. Це може бути повʼязано з нестачею амінокислоти, з якої мелатонін синтезується. Яка це амінокислота?',
    'medium',
    194,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Пацієнту з маніакально-депресивним синдромом у стадії депресії, який скаржився на відчуття тривоги та страху, призначено антидепресант із супутнім психоседативним ефектом. У кажіть цей препарат.',
    'medium',
    195,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Хворому з маніакально - депресивним синдромом в стадії депресії, який скаржився на відчуття тривоги, страху, був призначений антидепресант з супутнім психоседативним ефектом. Який це був препарат?',
    'medium',
    197,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'У хворої 59-ти років з нейроциркуляторною (первинною) артеріальною гіпотензією купіровано гіпотонічний криз підшкірним введенням 1 мл 20% розчину кофеїну бензоат натрію. Механізм дії цього препарату полягає у тому, що він блокує:',
    'medium',
    198,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'До лікаря звернувся юнак зі скаргами на біль у серці. Виявилося, що він випиває до 8 чашок кави на день. Як кофеїн, що міститься у каві, впливає на роботу серця людини?',
    'medium',
    200,
    true,
    NOW(),
  ...
  VALUES (
    v_question_id,
    'Уповільнює провідність в серці',
    false,
    1,
    NOW(),
    NOW()
  ...
  VALUES (
    v_question_id,
    'Викликає звуження коронарних судин',
    false,
    2,
    NOW(),
    NOW()
  ...
  VALUES (
    v_question_id,
    'Викликає тахікардію, збільшує потребу міокарда в кисні',
    true,
    3,
    NOW(),
    NOW()
  ...
  VALUES (
    v_question_id,
    'Послаблює силу серцевих скорочень',
    false,
    4,
    NOW(),
    NOW()
  ...
  VALUES (
    v_topic_id,
    'Призначення доксицикліну гідрохлориду зумовило порушення симбіозу мікробної флори в кишечнику. Вкажіть тип порушень при антибіотикотерапії.',
    'medium',
    210,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Хворий гіпотонією, відчувши погіршення загального стану прийняв без контролю лікаря кілька таблеток ефедрину через короткі проміжки часу. Але деякий час поліпшення спостерігав тільки після прийому першої таблетки. Яким явищем обумовлено таке дію?',
    'medium',
    217,
    true,
    NOW(),
