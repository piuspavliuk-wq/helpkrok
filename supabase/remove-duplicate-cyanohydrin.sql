-- Видалити другий дубль питання «Оберіть реагент, який можна використати для отримання ціангідрину ацетону:» (order_index = 100) з теми tema3.
