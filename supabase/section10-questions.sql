-- SQL для додавання питань до розділу 10: Мультисистемні процеси
-- Автоматично згенеровано
-- Кількість питань: 440
...
BEGIN
  ...
  -- Створюємо або знаходимо topic для розділу 10
  SELECT id INTO v_topic_id
  FROM topics
  WHERE course_id = v_course_id AND title = 'Мультисистемні процеси'
  LIMIT 1;
  ...
  IF v_topic_id IS NULL THEN
    ...
    VALUES (
      v_course_id,
      'Мультисистемні процеси',
      'Тести з мультисистемних процесів',
      0,
      true,
      NOW(),
      NOW()
  ...
  RAISE NOTICE 'Початок додавання питань для розділу 10...';
  ...
  VALUES (
    v_topic_id,
    'У чоловіка 54-х років, який 12 роківтому хворів на ревматичний міокардит та ендокардит, наявна недостатність мітрального клапану. Дослідження показали, що запального процесу зараз немає, хвилинний об’єм кровообігу достатній. Якому поняттю загальної нозології відповідає дана умова?',
    'medium',
    0,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'При огляді хворого лікар-стоматолог виявив наслідки опіку слизової ротової порожнини агресивною речовиною. Зі слів хворого, він випадково випив концентровану оцтову кислоту. Вказані зміни відповідають поняттю :',
    'medium',
    1,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Отруєння ботуліністичним токсином викликає блокаду нервово-м''язової передачі за рахунок пригнічення входу іонів кальцію до нервових закінчень аксонів мотонейронів. Що є безпосередньою небезпекою для життя і можливою причиною смерті у разі цього стану?',
    'medium',
    5,
    true,
    NOW(),
  ...
  VALUES (
    v_question_id,
    'Різке порушення регуляції тонусу судин',
    false,
    0,
    NOW(),
    NOW()
  ...
  VALUES (
    v_topic_id,
    'Отруєння ботуліністичним токсином, який блокує вхід іонів кальцію до нервоних закінчень аксонів мотонейронів, є небезпечним для життя. Яка загроза виника?',
    'medium',
    6,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'У пацієнта зупинилося дихання внаслідок травми в ділянці потилиці. Що могло стати причиною апное?',
    'medium',
    9,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'У клініку звернувся пацієнт після травми голови зі скаргами на втрату раніше набутих професійних навичок (праксії). Яка ділянка кори головного мозку ушкоджена?',
    'medium',
    11,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'У пацієнта внаслідок черепно-мозкової травми знижена шкірна чутливість. Яка ділянка кори великого мозку ймовірно уражена?',
    'medium',
    13,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Після травми у хворого спостерігається порушення моторних центрів, що регулюють діяльність м’язів голови. В яких ділянках кори півкуль в нормі локалізується відповідний центр?',
    'medium',
    14,
    true,
    NOW(),
  ...
  VALUES (
    v_question_id,
    'Верхня частина передцентральної звивини',
    false,
    1,
    NOW(),
    NOW()
  ...
  VALUES (
    v_question_id,
    'Нижня частина передцентральної звивини',
    true,
    2,
    NOW(),
    NOW()
  ...
  VALUES (
    v_topic_id,
    'У хворого після травми втрачена чутливість шкіри на долонній поверхні 5-го пальця лівої кисті. Який нерв пошкоджений?',
    'medium',
    25,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Дендрити й аксонУ хворого після травми виникла необхідність введення протиправцевої сироватки, але проба на чутливість до сироватки виявилася позитивною. Специфічну гіпосенсибілізацію у хворого слід виконати за допомогою введення:',
    'medium',
    27,
    true,
    NOW(),
  ...
  VALUES (
    v_question_id,
    'Мінімальних доз специфічного алергену',
    true,
    0,
    NOW(),
    NOW()
  ...
  VALUES (
    v_question_id,
    'Лікувальних доз антигістамінних препаратів',
    false,
    1,
    NOW(),
    NOW()
  ...
  VALUES (
    v_question_id,
    'Роздільної дози специфічного алергену',
    false,
    3,
    NOW(),
    NOW()
  ...
  VALUES (
    v_question_id,
    'Фізіологічних доз глюкокортикоїдів',
    false,
    4,
    NOW(),
    NOW()
  ...
  VALUES (
    v_question_id,
    'и чутливих псевдоуніполярних нейронів',
    false,
    5,
    NOW(),
    NOW()
  ...
  VALUES (
    v_topic_id,
    'Після травми на рентгенограмі постраждалого визначається перелом плеча у ділянці гребеня великого горбика. Функція якого м’яза буде у цьому випадку порушена?',
    'medium',
    47,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Внаслідок черепно-мозкової травми у хворого розвинулись наступні симптоми: інтенційний тремор, дисметрія, адіадохокінез, дизартрія. Яка структура головного мозку ушкоджена?',
    'medium',
    48,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'У хворої 53-х років внаслідок тупої травми живота діагностований розрив печінки. У якому анатомічному утворенні збереться кров, що вилилася?',
    'medium',
    54,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Після черепно-мозкової травми у хворого спостерігається втрата можливості виконувати знайомі до травми складно-координовані рухи (апраксія). У якій ділянці кори великих півкуль найімовірніше локалізується ушкодження?',
    'medium',
    55,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'До клініки доставили пацієнта 32 років з масивною крововтратою внаслідок автодорожної травми. Пульс 110 уд/хв., частота дихання - 22 за хв., АТ - 100/60 мм рт.ст. Яка зміна крові із перелічених буде найбільш характерною через 1 годину після крововтрати?',
    'medium',
    61,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'У жінки віком 42 роки незначне пошкодження шкіри внаслідок побутової травми призвело до активації судинно-тромбоцитарного гемостазу, завдяки чому кровотеча зупинилася протягом п''яти хвилин. Який із перелічених факторів є ключовим на стадії адгезії тромбоцитів під час формування тромбоцитарного тромбу?',
    'medium',
    64,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Чоловік внаслідок ДТП отримав травму і втратив велику кількість крові. Які зміни периферичної крові будуть найбільш імовірні на 2-й день після травми?',
    'medium',
    70,
    true,
    NOW(),
  ...
  VALUES (
    v_question_id,
    'Блокування ЦТК внаслідок зв’язування альфа-кетоглутарату',
    true,
    2,
    NOW(),
    NOW()
  ...
  VALUES (
    v_question_id,
    'Інгібування окисного фосфорилювання',
    false,
    3,
    NOW(),
    NOW()
  ...
  VALUES (
    v_topic_id,
    'Унаслідок травми гребеня клубової кістки в постраждалого відсутня чутливість шкіри в ділянці пупкового кільця й нижче. Який із нижченаведених нервів, найімовірніше ушкоджений?',
    'medium',
    74,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Після черепно-мозкової травми у пацієнта спостерігається втрата здатності сприймати написаний текст та читати (алексія). В якій ділянці кори півкуль у нормі локалізується відповідний центр?',
    'medium',
    76,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'У пацієнта - травма колінного суглоба із розтрощенням надколінника. Сухожилля якого м''яза стегна можуть бути пошкоджені у разі цієї травми?',
    'medium',
    77,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Після травми пацієнт не може утримувати тіло у вертикальному положенні та підніматися навшпиньки. Функція якого м''яза порушена?',
    'medium',
    79,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Під час оперативного втручання з приводу травми селезінки лікарю-хірургу необхідно перевʼязати артерію, що забезпечує її кровопостачання. Гілкою якої артеріальної судини вона є?',
    'medium',
    80,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Пацієнт віком 45 років після травми правого плеча внаслідок падіння не може відвести праву руку до горизонтального рівня. Пошкодження якого мʼязу викликало вказане обмеження руху?',
    'medium',
    85,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'У пацієнта віком 40 років після щелепно-лицевої травми порушилася функція підʼязичної та підщелепної залоз зліва. У цих залозах відзначається гіпосалівація. Функція якої пари нерв порушена?',
    'medium',
    86,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Людина отримала дозу іонізуючого опромінення 4 Гр. Яка зміна в крові потерпілого характерна насамперед?',
    'medium',
    88,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Клітина піддалася впливу іонізуючого опромінення при дефіциті вітаміну Е. Це сприяло посиленому виходу гідролітичних ферментів у цитоплазму і спричинило повне руйнування внутрішньоклітинних структур - аутоліз. Визначте, які органели клітини зумовили цей процес.',
    'medium',
    90,
    true,
    NOW(),
  ...
  VALUES (
    v_question_id,
    'Подразнювальною дією препарату',
    false,
    1,
    NOW(),
    NOW()
  ...
  VALUES (
    v_question_id,
    'Генетично обумовленою швидкістю ацетилювання препарату у різних людей',
    true,
    2,
    NOW(),
    NOW()
  ...
  VALUES (
    v_question_id,
    'Гіперглікемією, що виникає на тлі приймання препарату',
    false,
    4,
    NOW(),
    NOW()
  ...
  VALUES (
    v_question_id,
    'Пригніченням мікросомального окиснення',
    false,
    1,
    NOW(),
    NOW()
  ...
  VALUES (
    v_question_id,
    'Генетичним дефіцитом гідроксилази',
    false,
    4,
    NOW(),
    NOW()
  ...
  VALUES (
    v_topic_id,
    'Довготривалий емоційний стрес викликає підвищення секреції АКТГ, який стимулює секреторну функцію надниркової залози. Назвіть гормон, стимулююча дія якого в цих умовах зумовлює створення стану гіперглікемії.',
    'medium',
    110,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'В експерименті на білого щура подіяли стресовим фактором (електричним струмом) і спостерігали після цього гіпотонію м''язів, артеріальну гіпотензію, гіпотермію, гіпоглікемію. Який період загального адаптаційного синдрому у щура?',
    'medium',
    111,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Відомо, що одним з механізмів мобілізації організму у відповідь на стресові ситуації є вироблення адренокортикотропного гормону (АКТГ), який регулює синтез і виділення гормонів кори надниркових залоз. Який гормон викликає секрецію АКТГ у передній долі гіпофіза?',
    'medium',
    112,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'У хворого на черевний тиф при проведенні серологічного дослідження (реакція Відаля) виявлено О- і Н-аглютиніни у титрі 1:800 і 1:200 відповідно. Це свідчить про:',
    'medium',
    116,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'У тяжкотравмованої людини поступово настала біологічна смерть. Свідченням цього є:',
    'medium',
    118,
    true,
    NOW(),
  ...
  VALUES (
    v_question_id,
    'У клітинах відбувається автоліз і розкладання',
    true,
    0,
    NOW(),
    NOW()
  ...
  VALUES (
    v_question_id,
    'Відсутність серцебиття і дихання',
    false,
    1,
    NOW(),
    NOW()
  ...
  VALUES (
    v_topic_id,
    'Особам, які бажають схуднути, рекомендують включати в харчовий раціон побільше нежирної яловичини. Якими властивостями білків це пояснюється?',
    'medium',
    121,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'У жінки 35-ти років, яка протягом З місяців обмежувала кількість продуктів у харчовому раціоні, спостерігається зменшення маси тіла, погіршення фізичного стану та розумової діяльності, з’явилися набряки. Дефіцит яких харчових речовин міг призвести до таких змін?',
    'medium',
    123,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'У здорової людини визначили величину енерговитрат. У якому стані знаходилася людина, якщо її енерговитрати виявилися меншими за основний обмін?',
    'medium',
    130,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'У дитини 14-ти років був виявлений позитивний азотистий баланс. Що з наведеного може може бути причиною цього?',
    'medium',
    132,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Дефіцит яких речовин викликає дистрофічні зміни в нирках та серці, що характеризує захворювання Квашіоркор?',
    'medium',
    134,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'У трирічної дитини зі встановленим діагнозом: квашіоркор спостерігається порушення зроговіння епідермісу та збільшення його злущення, є жирова інфільтрація печінки. Який тип голодування спостерігається в цьому разі?',
    'medium',
    135,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'У добовому раціоні дорослої здорової людини повинні бути жири, білки, вуглеводи, вітаміни, мінеральні солі і вода. Вкажіть кількість білка, що забезпечує нормальну життєдіяльність організму.',
    'medium',
    136,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Десятирічна дівчинка часто хворіє на гострі респіраторні інфекції, після яких спостерігаються множинні точкові крововиливи в місцях тертя одягу. Укажіть, гіповітаміноз якого вітаміну має місце в цьому разі.',
    'medium',
    143,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Симптоми пелагри (гіповітаміноз PP) особливо різко виражені у хворих із недостатнім білковим харчуванням, тому що попередником нікотинаміду в органíзмі людини є одна з незамінних амінокислот. Укажіть цю амінокислоту.',
    'medium',
    144,
    true,
    NOW(),
  ...
  VALUES (
    v_question_id,
    'Сповільнюється всмоктування вітаміну',
    false,
    1,
    NOW(),
    NOW()
  ...
  VALUES (
    v_topic_id,
    'У 2-річної дитини кишковий дисбактеріоз, на фоні якого виник геморагічний синдром. Що є найбільш імовірною причиною геморагій у цієї дитини?',
    'medium',
    150,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Дівчинка 10 років часто хворіє на гострі респіраторні інфекції, після яких спостерігаються множинні точкові крововиливи в місцях тертя одягу. Гіповітаміноз якого вітаміну має місце у дівчинки?',
    'medium',
    151,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'У хворого в крові збільшення концентрації пірувату, значна кількість його екскретується з сечею. Який авітаміноз спостерігається у хворого?',
    'medium',
    155,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'У дитини 9-ти місяців спостерігаються запізніле прорізування зубів, порушення порядку прорізування, зміна конфігурація верхньої щелепи у горизонтальному напрямку (''''високе піднебіння''''). Мікроскопічно у зубах нерівномірна мінералізація емалі, зморщені емалеві призми, деякі вакуолізовані, розширення зони предентину, зустрічаються поодинокі дентиклі. Яке захворювання у дитини?',
    'medium',
    158,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Чоловіку з виразковою хворобою дванадцятипалої кишки лікар після курсу терапії пропонує вживання соків із капусти та картоплі. Вміст яких речовин у цих овочах сприяє профілактиці та загоєнню виразок?',
    'medium',
    166,
    true,
    NOW(),
  ...
  VALUES (
    v_question_id,
    'Лінолева кислота, вітаміни A, D, E, K',
    true,
    2,
    NOW(),
    NOW()
  ...
  VALUES (
    v_topic_id,
    'Під час огляду лікар-педіатр на шкірі десятирічної дитини виявив множинні петехії, а також спостерігається кровоточивість ясен і знижений рівень вітаміну С у сечі. Який процес порушений у цьому разі?',
    'medium',
    183,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Визначення активності трансаміназ широко застосовується з метою діагностики пошкоджень внутрішніх органів. Активна форма якого вітаміну є кофактором цих ферментів?',
    'medium',
    184,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'У пацієнта якому діагностовано пелагру. В якому типі реакцій важливу роль відіграє вітамін РР?',
    'medium',
    185,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'У жінки віком 26 років об’єктивно спостерігається порушення зору в сутінаках, підсихання кон’юктиви та рогової оболонки. Дефіцит якого вітаміну є причиною цього патологічного стану?',
    'medium',
    186,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Злоякісна гіперхромна анемія (хвороба Бірмера) виникає внаслідок нестачі вітаміну В12. Який біоелемент міститься у складі цього вітаміну?',
    'medium',
    188,
    true,
    NOW(),
  ...
  VALUES (
    v_question_id,
    'Утворення гідроксипроліну і гідроксилізину',
    true,
    1,
    NOW(),
    NOW()
  ...
  VALUES (
    v_topic_id,
    'Реакції міжмолекулярного транспорту одновуглецевих радикалів є обов’язковими для синтезу білків та нуклеїнових кислот. Коферментна форма якого вітаміну є переносником одновуглецевих фрагментів у цьому синтезі?',
    'medium',
    190,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Лікар-офтальмолог під час огляду жінки віком 46 років виявив збільшення часу адаптації ока до темряви. Дефіцит якого вітаміну може спричинити такі симптоми?',
    'medium',
    191,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'У п`ятирічної дитини зі спадковим ураженням нирок під час огляду виявлено ознаки рахіту, в лабораторних показниках концентрація вітаміну D в нормі. Яка найімовірніша причина розвитку рахіту?',
    'medium',
    192,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Який вітамін входить як кофермент до складу декарбоксилази глутамінової кислоти, бере участь в утворенні ГАМК, а його недостатність проявляється судомами?',
    'medium',
    194,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Посттрансляційна модифікація вітамінозалежних факторів зсідання крові полягає у перетворенні залишку глутамінової кислоти в гамма-карбоксиглутаміназу. Укажіть необхідний для цього вітамін.',
    'medium',
    196,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'У шестимісячної дитини спостерігалися часті та сильні підшкірні кровотечі. Призначення синтетичного аналога вітаміну К (вікасола) дало позитивний ефект. У γ-карбоксилюванні глутамінової кислоти якого з нижченаведених білків згортальної системи крові бере участь цей вітамін?',
    'medium',
    209,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Під час огляду лікарем-педіатром на шкірі десятирічної дитини виявлено множинні петехії, а також спостерігається кровоточивість ясен та знижений рівень вітаміну С в сечі. Який процес порушений у цьому разі?',
    'medium',
    210,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'При хворобі Верніке-Корсакова, що часто спостерігається у хронічних алкоголіків, харчовий раціон яких містить мало вітамінів, визначається зниження активності транскетолази. Нестача якого вітаміну призводить до цього?',
    'medium',
    212,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Хворому на активну форму туберкульозу призначили ізоніазид. Який вітамінний препарат необхідно застосовувати для профілактики побічної дії ізоніазиду?',
    'medium',
    218,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Синдром Верніке-Корсакова зазвичай спостерігається у хронічних алкоголіків, харчовий раціон яких містить мало вітамінів, що спричиняє зниження активності транскетолази. Дефіцит якого вітаміну до цього призводить?',
    'medium',
    220,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'У пацієнта дефіцит вітаміну D. Всмоктування якого мікроелементу порушиться?',
    'medium',
    222,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'У дитини, яку годували синтетичними сумішами, з''явилися ознаки недостатності вітаміну B1. У яких реакціях бере участь цей вітамін?',
    'medium',
    223,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Вітамін А у комплексі зі специфічними циторецепторами проникає через ядерні мембрани, індукує процеси транскрипції, що стимулює ріст та диференціацію клітин. Якою формою вітаміну А реалізується ця біологічна функція?',
    'medium',
    226,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Реакції міжмолекулярного транспорту одновуглецевих радикалів є обов''якзовими для синтезу білків та нуклеїнових кислот. Коферментна форма якого вітаміну є переносником одновуглецевих фрагментів у цьому синтезі?',
    'medium',
    227,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Коензим А бере участь в багатьох важливих реакціях метаболізму. Похідним якого вітаміну він є?',
    'medium',
    228,
    true,
    NOW(),
  ...
  VALUES (
    v_question_id,
    'Амінокислот та біогенних амінів',
    true,
    2,
    NOW(),
    NOW()
  ...
  VALUES (
    v_topic_id,
    'Для комплексної терапії туберкульозу було призначено препарат, що є антагоністом вітаміну В6. Назвіть цей препарат:',
    'medium',
    233,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'У 6-місячної дитини спостерігались часті та сильні підшкірні кровотечі. Призначення синтетичного аналога вітаміну К (вікасола) дало позитивний ефект. В гамма-карбоксилюванні глутамінової кислоти якого з перерахованих нижче білків згортальної системи крові бере участь цей вітамін?',
    'medium',
    239,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Лікар-гематолог призначив пацієнту з кровотечею коагулянт, який діє шляхом підвищення синтезу протромбіну та інших факторів зсідання крові переважно в печінці і є синтетичним водорозчинним вітаміном. Який препарат призначив лікар?',
    'medium',
    241,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'У клінічній практиці для лікування туберкульозу застосовують препарат ізоніазид - антивітамін, який здатний проникати у туберкульозну паличку. Туберкулостатичний ефект обумовлений порушенням процесів реплікації, окисновідновних реакцій, завдяки утворенню несправжнього коферменту з:',
    'medium',
    270,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'У хворих з непрохідністю жовчовивідних шляхів пригнічується зсідання крові, виникають кровотечі, що є наслідком недостатнього засвоєння такого вітаміну:',
    'medium',
    272,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Унаслідок посттрансляційних змін деяких білків, що приймають участь у зсіданні крові, зокрема протромбіну, вони набувають здатності зв’язувати кальцій. У цьому процесі бере участь вітамін:',
    'medium',
    278,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Унаслідок дефіциту вітаміну B1 порушується окисне декарбоксилювання α-кетоглутарової кислоти. Синтез якого з наведених коферментів порушується при цьому?',
    'medium',
    280,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'У чоловіка 52 років через 3 роки після операції видалення шлунка вміст еритроцитів у крові становить 2,0×10^12/л, Hb - 85 г/л, к.п. - 1,27. Порушення засвоєння якого вітаміну викликало такі зміни?',
    'medium',
    296,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'У результаті безконтрольного прийому вітамінного препарату у дитини з''явилися анорексія, нудота, блювота, пронос, гіпертермія, з''явилися крововиливи на шкірі та слизових, а також явища менінгізма. Який препарат приймав дитина?',
    'medium',
    297,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'У жінки, яка має розлади менструального циклу, що супроводжуються тривалими кровотечами, виявлено гіпохромію, зниження кількості ретикулоцитів, мікроцитоз та гіпосидеремію. До якої групи за патогенезом відноситься цей вид анемії?',
    'medium',
    298,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'У пацієнта з хронічним гіпоацидним гастритом спостерігаються симптоми гіпохромної анемії. Під час мікроскопічного дослідження мазку крові виявлено: анулоцити, мікроанізоцитоз, пойкілоцитоз. Який вид анемії спостерігається у пацієнта?',
    'medium',
    299,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Жінка віком 37 років скаржиться на головний біль, запаморочення, поганий сон, затерпання кінцівок. Упродовж 6 років працює на заводі газорозрядних ламп у свинцевому цеху. Під час лабораторного аналізу крові виявлено знижену кількість еритроцитів та гемоглобіну, підвищений в декілька разів уміст сироваткового заліза. Який вид анемії у жінки?',
    'medium',
    302,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'У пацієнтки віком 15 років з вадою мітрального клапана з’явився кашель із виділенням мокротиння іржавого кольору. Який пігмент обумовив такий колір мокротиння?',
    'medium',
    309,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'На земній кулі існують території (біохімічні провінції) частина населення яких страждає на ендемічний зоб. Дефіцит якого біоелемента в грунті, воді та харчових продуктах викликає це захворювання?',
    'medium',
    312,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Прикарпатський регіон — біогеохімічна зона нестачі мікроелемента, який необхідний для синтезу тиреоїдних гормонів. Укажіть цей елемент.',
    'medium',
    314,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'У пацієнта віком 50 років в анамнезі наявні часті епізоди ниркової кольки з кальцій-вмісними каменями в нирках. У результаті обстеження виявлено дефект проксимальної канальцевої реабсорбції кальцію, що призводить до високих концентрацій солей кальцію в сечі. Укажіть найоптимальніший діуретичний засіб для профілактики утворення кальцієвих ниркових конкрементів.',
    'medium',
    315,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'У пацієнта віком 40 років спостерігається: ожиріння та зниження температури тіла, ламкість нігтів, випадіння волосся та інші трофічні порушення, обличчя пастозне з бідною мімікою, стовщеним носом і губами, статева функція зменшена, погіршилася пам''ять. Малорухливий. Для якої ендокринної патології характерні такі клінічні показники?',
    'medium',
    320,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'У чоловіка 63-х років рак стравоходу, метастази у лімфатичні вузли середостіння, ракова кахексія. Яка патогенетична стадія пухлинного процесу має місце?',
    'medium',
    334,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Хворий у непритомному стані доставлений бригадою швидкої допомоги у лікарню. Об''єктивно: рефлекси відсутні, періодично з’являються судоми, дихання нерівномірне. Після лабораторного обстеження було діагностовано печінкову кому. Нагромадження якого метаболіту є суттєвим для появи розладів центральної нервової системи?',
    'medium',
    336,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Основна маса азоту з організму виводиться у вигляді сечовини. Зниження активності якого ферменту в печінці призводить до гальмування синтезу сечовини й нагромадження амоніаку в крові й тканинах?',
    'medium',
    337,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Під час посмертного розтину тіла чоловіка, який проходив військову службу на підводному атомному човні, виявлено такі патології: спустошення в кістковому мозку (панмієлофтиз), анемія, лейкопенія, тромбоцитопенія, розпад лімфоцитів у лімфатичних вузлах, селезінці, лімфатичному апараті шлунково-кишкового тракту, крововиливи наднирники. Яке захворювання розвинулося у чоловіка?',
    'medium',
    339,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'У ліквідатора наслідків на АЕС під час перебігу гострої променевої хвороби виник геморагічний синдром. Що має найбільше значення в патогенезі цього синдрому?',
    'medium',
    340,
    true,
    NOW(),
  ...
  VALUES (
    v_question_id,
    'Порушення структури сінки судин',
    false,
    2,
    NOW(),
    NOW()
  ...
  VALUES (
    v_topic_id,
    'Дитина 9-ти місяців захворіла на тяжку пневмонію гнійно-деструктивного характеру, з приводу якої проводилася масивна антибактеріальна терапія. Захворювання швидко прогресувало, на тлі вираженої інтоксикації зафіксовано падіння артеріального тиску, розвиток шоку, від якого дитина померла. Яка етіопатогенетична форма шоку розвинулася у дитини?',
    'medium',
    346,
    true,
    NOW(),
  ...
  VALUES (
    v_question_id,
    'Активація симнато-адреналової системи',
    false,
    4,
    NOW(),
    NOW()
  ...
  VALUES (
    v_topic_id,
    'Відомо, що у разі гострого отруєння морфіном використовується специфічний антагоніст - налоксон. Який фактор являється основним у розвитку його антагоністичної дії?',
    'medium',
    377,
    true,
    NOW(),
  ...
  VALUES (
    v_question_id,
    'Зменшення чутливості організму до морфіну',
    false,
    0,
    NOW(),
    NOW()
  ...
  VALUES (
    v_question_id,
    'Конкуренція за зв''язування з <<опіатними>> рецепторами',
    true,
    1,
    NOW(),
    NOW()
  ...
  VALUES (
    v_question_id,
    'Пряме збудження дихального центру',
    false,
    2,
    NOW(),
    NOW()
  ...
  VALUES (
    v_question_id,
    'Різке прискорення метаболізму морфіну',
    false,
    4,
    NOW(),
    NOW()
  ...
  VALUES (
    v_topic_id,
    'До приймального відділення лікарні госпіталізовано п''ятирічну дитину, у якої встановлено такі симптоматичні явища: сильне рухове збудження, марення, хрипкий голос, розширені зіниці, які не реагують на світло, суха, гаряча, гіперемована шкіра, тахікардія і тахіпное. Ці симптоми виникли після споживання дитиною ягід беладони. Препарат якої фармакологічної групи треба призначити?',
    'medium',
    378,
    true,
    NOW(),
  ...
  VALUES (
    v_question_id,
    'Збудження Н1-гістамінових рецепторів',
    false,
    1,
    NOW(),
    NOW()
  ...
  VALUES (
    v_question_id,
    'Пригнічення лейкотрієнових рецепторів',
    false,
    2,
    NOW(),
    NOW()
  ...
  VALUES (
    v_question_id,
    'Збудження beta-адренорецепторів',
    false,
    4,
    NOW(),
    NOW()
  ...
  VALUES (
    v_question_id,
    'Блокада бета2-адренореценторів. Призначити селективний бета1-адреноблокатор',
    true,
    0,
    NOW(),
    NOW()
  ...
  VALUES (
    v_question_id,
    'Блокада бета1-адренорецепторів. Призначити селективний бета2-адреноблокатор',
    false,
    1,
    NOW(),
    NOW()
  ...
  VALUES (
    v_question_id,
    'Викликає збудження барорецепторів',
    false,
    3,
    NOW(),
    NOW()
  ...
  VALUES (
    v_question_id,
    'Блокування натрієвих іоноселективних каналів',
    true,
    1,
    NOW(),
    NOW()
  ...
  VALUES (
    v_question_id,
    'Блокування кальцієвих іоноселективних каналів',
    false,
    2,
    NOW(),
    NOW()
  ...
  VALUES (
    v_question_id,
    'Блокування калієвих іоноселективних каналів',
    false,
    4,
    NOW(),
    NOW()
  ...
  VALUES (
    v_topic_id,
    'Основний спосіб зняття гіпертонічного кризу - швидке і значне зниження судинного опору. Ін''єкційні препарати якої групи адреноблокаторів можуть бути використані для цього?',
    'medium',
    388,
    true,
    NOW(),
  ...
  VALUES (
    v_question_id,
    'Кардіоселективні beta-адреноблокатори',
    false,
    1,
    NOW(),
    NOW()
  ...
  VALUES (
    v_topic_id,
    'Чоловік віком 68 років хворіє на гіпертонічну хворобу та тривалий час приймає антигіпертензивний препарат, який раптово припинив вживати. Після цього стан пацієнта погіршився, розвинувся гіпертензивний криз. Який патологічний стан розвинувся у чоловіка після зупинки прийому препарату?',
    'medium',
    394,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Пацієнтка віком 57 років для лікування гіпертонічної хвороби тривалий час приймала анаприлін. Через виникнення побічних ефектів пацієнтка відмовилася від прийому лікарського засобу, що спричинило розвиток гіпертонічної кризи та нападу стенокардії. Як називається ускладнення, що виникло в пацієнтки?',
    'medium',
    395,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Унаслідок порушення правил безпеки при роботі з фосфорорганічним інсек-тицидом у працівника виник бронхоспазм. Який із запропонованих бронхолітиків показаний у цій ситуації?',
    'medium',
    413,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'У пацієнта відбувся напад бронхоспазму. Які мембранні циторецептори гладеньких мʼязів бронхів треба стимулювати для покращення стану пацієнта?',
    'medium',
    414,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Пацієнт з діагнозом: ішемічна хвороба серця, не повідомив сімейному лікарю, що в нього бувають напади бронхоспазму. Лікар призначив засіб, після прийому якого напади стенокардії трапляються рідше, але напади бронхоспазму почастішали. Який ймовірно лікарський засіб було призначено?',
    'medium',
    416,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Хворий 40-ка років страждає на бронхіальну астму та скаржиться на тахікардію протягом тривалого часу. Вкажіть найбільш оптимальний в даній ситуації препарат для купірування бронхоспазму:',
    'medium',
    417,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Хворий 40-ка років впродовж тривалого часу страждає на бронхіальну астму і тахікардію. Вкажіть найдоцільніший в даній ситуації препарат для усунення бронхоспазму:',
    'medium',
    422,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Хворому на бронхіальну астму призначено інгаляції 0,5% розчину ізадрину. Бронхоспазм був усунутий, але пацієнт почав скаржитися на болі в серці та серцебиття. Це пов''язано зі стимуляцією:',
    'medium',
    424,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Пацієнт був доставлений до лікарні з такими симптомами: запаморочення, сухість в роті, зіниці сильно розширені, порушення акомодації, тахікардія, утруднення сечовипускання, атонія кишечника. Передозування якого препарату могло викликати ці симптоми?',
    'medium',
    427,
    true,
    NOW(),
  ...
  VALUES (
    v_topic_id,
    'Внаслідок отруєння неякісною їжею хворому було промито шлунок розчином калію перманганату. Який механізм дії цього засобу?',
    'medium',
    429,
    true,
    NOW(),
  ...
  VALUES (
    v_question_id,
    'Пригнічення вивільнення гістаміну',
    false,
    0,
    NOW(),
    NOW()
  ...
  VALUES (
    v_question_id,
    'Незалежний антагонізм з гістаміном',
    false,
    2,
    NOW(),
    NOW()
  ...
  VALUES (
    v_topic_id,
    'При отруєнні сполуками кобальту призначили унітіол. Який принцип допомоги обумовлює призначення препарату?',
    'medium',
    434,
    true,
    NOW(),
  ...
  VALUES (
    v_question_id,
    'Симптоматичної допомоги за ознаками отруєння',
    false,
    0,
    NOW(),
    NOW()
  ...
  VALUES (
    v_question_id,
    'Прискорення виведення токсикантів',
    false,
    1,
    NOW(),
    NOW()
  ...
  VALUES (
    v_question_id,
    'Припинення надходження токсикантів',
    false,
    2,
    NOW(),
    NOW()
  ...
  VALUES (
    v_question_id,
    'Неспецифічної дезінтоксикаійної допомоги',
    false,
    3,
    NOW(),
    NOW()
  ...
  VALUES (
    v_question_id,
    'Специфічної антидотної терапії',
    true,
    4,
    NOW(),
    NOW()
  ...
  VALUES (
    v_topic_id,
    'Стоматолог призначив пацієнту препарати кальцію для профілактики карієсу. Лікар не знав, що пацієнт хворіє на хронічну серцеву недостатність і приймає серцеві глікозиди. Що відбудеться в результаті поєднання препаратів кальцію і серцевих глікозидів?',
    'medium',
    439,
    true,
    NOW(),
  ...
  VALUES (
    v_question_id,
    'Уповільниться метаболізм серцевих глікозидів',
    false,
    0,
    NOW(),
    NOW()
  ...
  VALUES (
    v_question_id,
    'Знизиться активність і токсичність серцевих глікозидів',
    false,
    1,
    NOW(),
    NOW()
  ...
  VALUES (
    v_question_id,
    'Прискориться виведення серцевих глікозидів',
    false,
    2,
    NOW(),
    NOW()
  ...
  RAISE NOTICE 'Додано питань: 440';
END $$;
