...
-- Видалити старі питання теми Нітрогеновмісні органічні сполуки
...
-- Курс і тема мають вже існувати; вставляємо лише питання з Untitled document.txt
...
WITH inserted_question AS (
  ...
  SELECT t.id, '1. В якій із наведених сполук присутня первинна ароматична аміногрупа? Якою реакцією можна це підтвердити?', NULL, 'medium', 1, true, NULL
  FROM topics t
  JOIN courses c ON c.id = t.course_id
  WHERE c.title = 'Основи знань про органічні сполуки'
    AND t.title = 'Нітрогеновмісні органічні сполуки'
...
WITH inserted_question AS (
  INSERT INTO questions (topic_id, question_text, explanation, difficulty, order_index, is_active, image_url)
  SELECT t.id, '2. Які з перерахованих реакцій треба провести, щоб одержати азобарвник із ароматичного аміну?', NULL, 'medium', 2, true, NULL
  FROM topics t
  JOIN courses c ON c.id = t.course_id
  WHERE c.title = 'Основи знань про органічні сполуки'
    AND t.title = 'Нітрогеновмісні органічні сполуки'
...
WITH inserted_question AS (
  INSERT INTO questions (topic_id, question_text, explanation, difficulty, order_index, is_active, image_url)
  SELECT t.id, '3. При вивченні хімічних властивостей органічної сполуки встановлено, що вона проявляє основні властивості та легко вступає в реакції галогенування й діазотування. Укажіть сполуку, що відповідає вказаним критеріям.', NULL, 'medium', 3, true, NULL
  FROM topics t
  JOIN courses c ON c.id = t.course_id
  WHERE c.title = 'Основи знань про органічні сполуки'
    AND t.title = 'Нітрогеновмісні органічні сполуки'
...
WITH inserted_question AS (
  INSERT INTO questions (topic_id, question_text, explanation, difficulty, order_index, is_active, image_url)
  SELECT t.id, '4. Азобарвники утворюються в результаті реакції:', NULL, 'medium', 4, true, NULL
  FROM topics t
  JOIN courses c ON c.id = t.course_id
  WHERE c.title = 'Основи знань про органічні сполуки'
    AND t.title = 'Нітрогеновмісні органічні сполуки'
...
WITH inserted_question AS (
  INSERT INTO questions (topic_id, question_text, explanation, difficulty, order_index, is_active, image_url)
  SELECT t.id, '5. Який з наведених амінів НЕ утворює солі діазонію в умовах реакції діазотування', NULL, 'medium', 5, true, '/test-images/organic/tema2/page2_img1.png'
  FROM topics t
  JOIN courses c ON c.id = t.course_id
  WHERE c.title = 'Основи знань про органічні сполуки'
    AND t.title = 'Нітрогеновмісні органічні сполуки'
...
INSERT INTO question_options (question_id, option_text, is_correct, order_index) VALUES
  ...
  ((SELECT id FROM inserted_question), 'B', true, 2),
  ((SELECT id FROM inserted_question), 'C', false, 3),
  ((SELECT id FROM inserted_question), 'D', false, 4),
  ((SELECT id FROM inserted_question), 'E', false, 5);

-- Question 6
WITH inserted_question AS (
  INSERT INTO questions (topic_id, question_text, explanation, difficulty, order_index, is_active, image_url)
  SELECT t.id, '6. Більшість нітритометричних визначень ґрунтується на реакціях діазотування:', NULL, 'medium', 6, true, '/test-images/organic/tema2/page2_img1.png'
  FROM topics t
  JOIN courses c ON c.id = t.course_id
  WHERE c.title = 'Основи знань про органічні сполуки'
    AND t.title = 'Нітрогеновмісні органічні сполуки'
...
WITH inserted_question AS (
  INSERT INTO questions (topic_id, question_text, explanation, difficulty, order_index, is_active, image_url)
  SELECT t.id, '7. При визначенні стрептоциду (ароматичного аміну) методом нітритометрії для прискорення реакції діазотування додають каталізатор. Вкажіть речовину, яка виконує роль каталізатора:', NULL, 'medium', 7, true, '/test-images/organic/tema2/page2_img1.png'
  FROM topics t
  JOIN courses c ON c.id = t.course_id
  WHERE c.title = 'Основи знань про органічні сполуки'
    AND t.title = 'Нітрогеновмісні органічні сполуки'
...
INSERT INTO question_options (question_id, option_text, is_correct, order_index) VALUES
  ...
  ((SELECT id FROM inserted_question), 'Калій сульфат', false, 2),
  ((SELECT id FROM inserted_question), 'Сульфатна кислота', false, 3),
  ((SELECT id FROM inserted_question), 'Натрій хлорид', false, 4);

-- Question 8
WITH inserted_question AS (
  INSERT INTO questions (topic_id, question_text, explanation, difficulty, order_index, is_active, image_url)
  SELECT t.id, '8. Аміди є слабкими NH-кислотами. Під час взаємодії з яким з наведених реагентів вони утворюють солі?', NULL, 'medium', 8, true, NULL
  FROM topics t
  JOIN courses c ON c.id = t.course_id
  WHERE c.title = 'Основи знань про органічні сполуки'
    AND t.title = 'Нітрогеновмісні органічні сполуки'
...
WITH inserted_question AS (
  INSERT INTO questions (topic_id, question_text, explanation, difficulty, order_index, is_active, image_url)
  SELECT t.id, '9. Вкажіть реагенти, що дозволять підтвердити наявність первинної аміногрупи в молекулі n-амінобензойної кислоти за допомогою ізонітрильної проби:', NULL, 'medium', 9, true, NULL
  FROM topics t
  JOIN courses c ON c.id = t.course_id
  WHERE c.title = 'Основи знань про органічні сполуки'
    AND t.title = 'Нітрогеновмісні органічні сполуки'
...
WITH inserted_question AS (
  INSERT INTO questions (topic_id, question_text, explanation, difficulty, order_index, is_active, image_url)
  SELECT t.id, 'Яку з наведених реакцій можна використовувати для ідентифікації первинної аміногрупи?', NULL, 'medium', 10, true, '/test-images/organic/tema2/page4_img1.png'
  FROM topics t
  JOIN courses c ON c.id = t.course_id
  WHERE c.title = 'Основи знань про органічні сполуки'
    AND t.title = 'Нітрогеновмісні органічні сполуки'
...
INSERT INTO question_options (question_id, option_text, is_correct, order_index) VALUES
  ((SELECT id FROM inserted_question), '-', false, 0),
  ((SELECT id FROM inserted_question), 'A', true, 1),
  ((SELECT id FROM inserted_question), 'B', false, 2),
  ((SELECT id FROM inserted_question), 'C', false, 3),
  ((SELECT id FROM inserted_question), 'D', false, 4),
  ((SELECT id FROM inserted_question), 'E', false, 5);
...
WITH inserted_question AS (
  INSERT INTO questions (topic_id, question_text, explanation, difficulty, order_index, is_active, image_url)
  SELECT t.id, 'Для піридину характерні реакції електрофільного (SE ) та нуклеофільного (SN ) заміщення. Низька реакційна здатніть піридину в реакціях SE обумовлена:', NULL, 'medium', 15, true, '/test-images/organic/tema2/page5_img1.png'
  FROM topics t
  JOIN courses c ON c.id = t.course_id
  WHERE c.title = 'Основи знань про органічні сполуки'
    AND t.title = 'Нітрогеновмісні органічні сполуки'
...
INSERT INTO question_options (question_id, option_text, is_correct, order_index) VALUES
  ((SELECT id FROM inserted_question), '-', false, 0),
  ((SELECT id FROM inserted_question), 'Електроноакцепторними властивостями атому нітрогену', true, 1),
  ((SELECT id FROM inserted_question), 'Ароматичним характером піридинового ядра', false, 2),
  ((SELECT id FROM inserted_question), 'Основними властивостями', false, 3),
  ((SELECT id FROM inserted_question), 'Гібридизацією атомів карбону', false, 4),
  ((SELECT id FROM inserted_question), 'Розміром циклу', false, 5);
...
WITH inserted_question AS (
  INSERT INTO questions (topic_id, question_text, explanation, difficulty, order_index, is_active, image_url)
  SELECT t.id, 'Вкажіть положення, за яким переважно проходить реакція нітрування саліцилової кислоти?', NULL, 'medium', 22, true, '/test-images/organic/tema2/page8_img1.png'
  FROM topics t
  JOIN courses c ON c.id = t.course_id
  WHERE c.title = 'Основи знань про органічні сполуки'
    AND t.title = 'Нітрогеновмісні органічні сполуки'
...
INSERT INTO question_options (question_id, option_text, is_correct, order_index) VALUES
  ...
  ((SELECT id FROM inserted_question), '6', false, 2),
  ((SELECT id FROM inserted_question), '3 та 6', false, 3),
  ((SELECT id FROM inserted_question), '5', true, 4),
  ((SELECT id FROM inserted_question), '2', false, 5);

-- Question 23
WITH inserted_question AS (
  INSERT INTO questions (topic_id, question_text, explanation, difficulty, order_index, is_active, image_url)
  SELECT t.id, 'Укажіть положення в молекулі індолу, за яким проходить реакція його нітрування.', NULL, 'medium', 23, true, '/test-images/organic/tema2/page8_img1.png'
  FROM topics t
  JOIN courses c ON c.id = t.course_id
  WHERE c.title = 'Основи знань про органічні сполуки'
    AND t.title = 'Нітрогеновмісні органічні сполуки'
...
INSERT INTO question_options (question_id, option_text, is_correct, order_index) VALUES
  ...
  ((SELECT id FROM inserted_question), '3', true, 3),
  ((SELECT id FROM inserted_question), '4', false, 4),
  ((SELECT id FROM inserted_question), '5', false, 5);
...
WITH inserted_question AS (
  INSERT INTO questions (topic_id, question_text, explanation, difficulty, order_index, is_active, image_url)
  SELECT t.id, 'Ацетилсаліцилова кислота утворюється в результаті нижченаведеної реакції. До якого типу реакцій вона належить?', NULL, 'medium', 26, true, '/test-images/organic/tema2/page9_img1.png'
  FROM topics t
  JOIN courses c ON c.id = t.course_id
  WHERE c.title = 'Основи знань про органічні сполуки'
    AND t.title = 'Нітрогеновмісні органічні сполуки'
...
INSERT INTO question_options (question_id, option_text, is_correct, order_index) VALUES
  ((SELECT id FROM inserted_question), '-', false, 0),
  ((SELECT id FROM inserted_question), 'Відщеплення', false, 1),
  ((SELECT id FROM inserted_question), 'Електрофільного заміщення', false, 2),
  ((SELECT id FROM inserted_question), 'Приєднання', false, 3),
  ((SELECT id FROM inserted_question), 'Ацилювання', true, 4),
  ((SELECT id FROM inserted_question), 'Відновлення', false, 5);
...
WITH inserted_question AS (
  INSERT INTO questions (topic_id, question_text, explanation, difficulty, order_index, is_active, image_url)
  SELECT t.id, 'Укажіть назву п’ятичленного гетероциклу, що містить гетероатоми нітрогену пірольного та піридинового типу.', NULL, 'medium', 28, true, NULL
  FROM topics t
  JOIN courses c ON c.id = t.course_id
  WHERE c.title = 'Основи знань про органічні сполуки'
    AND t.title = 'Нітрогеновмісні органічні сполуки'
...
WITH inserted_question AS (
  INSERT INTO questions (topic_id, question_text, explanation, difficulty, order_index, is_active, image_url)
  SELECT t.id, 'Пірол відноситься до:', NULL, 'medium', 29, true, NULL
  FROM topics t
  JOIN courses c ON c.id = t.course_id
  WHERE c.title = 'Основи знань про органічні сполуки'
    AND t.title = 'Нітрогеновмісні органічні сполуки'
...
INSERT INTO question_options (question_id, option_text, is_correct, order_index) VALUES
  ...
  ((SELECT id FROM inserted_question), 'Шестичленних гетероциклів з одним гетероатомом', false, 2),
  ((SELECT id FROM inserted_question), 'П’ятичленних гетероциклів з двома гетероатомами', false, 3),
  ((SELECT id FROM inserted_question), 'П’ятичленних гетероциклів з одним гетероатомом', true, 4),
  ((SELECT id FROM inserted_question), 'Шестичленних гетероциклів з двома гетероатомами', false, 5);
