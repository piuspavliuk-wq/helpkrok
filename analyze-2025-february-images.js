...
// Читаємо JSON файл
const jsonFile = '/Users/bohdanpavliuk/Desktop/help-krok-platform/data/2025-pharmacy-february-questions-1760208221875.json';
const data = JSON.parse(fs.readFileSync(jsonFile, 'utf8'));

console.log('🔍 Аналізуємо зображення в файлі 2025 лютий...');
...
let sql = `-- SQL для імпорту питань фармації 2025 лютий (без великих зображень)
-- Кількість питань: ${limitedData.questions.length}
-- Назва тесту: 2025 лютий
...
const limitedSqlFile = '/Users/bohdanpavliuk/Desktop/help-krok-platform/data/2025-pharmacy-february-questions-1760208221875-limited-50kb.sql';
...
if (fileSize > 5000000) { // > 5MB
  ...
  let noImagesSql = `-- SQL для імпорту питань фармації 2025 лютий (без зображень)
...
`;
  ...
  const noImagesSqlFile = '/Users/bohdanpavliuk/Desktop/help-krok-platform/data/2025-pharmacy-february-questions-1760208221875-no-images.sql';
