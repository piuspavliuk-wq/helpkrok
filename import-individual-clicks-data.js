...
// Функція для генерації випадкової категорії
function getRandomCategory() {
  const categories = [
    'анатомія', 'фізіологія', 'патологія', 'фармакологія', 
    'мікробіологія', 'гігієна', 'педіатрія', 'терапія',
    'хірургія', 'акушерство', 'гінекологія', 'неврологія'
  ];
...
const sqlContent = `-- Krok Lead Questions Import
-- Source: ${data.source}
-- URL: ${data.url}
...
// Зберігаємо SQL файл
const sqlFilename = `krok-lead-${questions.length}-questions-individual-clicks-${Date.now()}.sql`;
