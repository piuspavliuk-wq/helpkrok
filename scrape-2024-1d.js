...
// Конфігурація для тесту "2024р 1д"
const testConfig = {
  year: 2024,
...
async function run2024Day1Scraper() {
  console.log('🚀 ЗАПУСКАЄМО СКРАПЕР ДЛЯ "2024р 1д" З ТАЙМЕРОМ 5 ХВИЛИН...');
  console.log('');
  
  const scraper = new Pharmacy2024Day1Scraper(testConfig);
...
if (require.main === module) {
  run2024Day1Scraper().catch(console.error);
}

module.exports = { Pharmacy2024Day1Scraper, run2024Day1Scraper };
