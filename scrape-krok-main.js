...
async function scrapeFromMain() {
  console.log('🚀 Запуск браузера з головної сторінки Krok Lead...');
  ...
  try {
    ...
    // Таймер 30 секунд для навігації
    console.log('\n⏰ ТАЙМЕР 30 СЕКУНД ДЛЯ НАВІГАЦІЇ');
    ...
    const filename = `krok-lead-main-${timestamp}.json`;
