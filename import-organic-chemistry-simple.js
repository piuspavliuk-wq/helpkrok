...
async function importOrganicChemistrySimple() {
  try {
    console.log('🚀 Початок імпорту питань з органічної хімії (проста версія)...');
    ...
    // Підготовка даних для вставки (без зображень)
