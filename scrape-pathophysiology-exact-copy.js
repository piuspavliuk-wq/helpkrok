...
class MicrobiologyScraper {
  ...
  generateSQL(questions) {
    ...
    let sql = '-- SQL для вставки питань з патфізіології\n';
    ...
    questions.forEach((question, index) => {
      ...
      sql += `INSERT INTO pathophysiology_questions (question_text, option_a, option_b, option_c, option_d, option_e, correct_answer, created_at) VALUES (\n`;
      sql += `  '${questionText}',\n`;
      sql += `  '${optionA}',\n`;
      sql += `  '${optionB}',\n`;
      sql += `  '${optionC}',\n`;
