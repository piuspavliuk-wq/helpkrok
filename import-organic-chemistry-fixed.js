...
async function importOrganicChemistryFixed() {
  try {
    console.log('🚀 Початок імпорту питань з органічної хімії (виправлена версія)...');
    ...
    const jsonFiles = files.filter(file => file.startsWith('krok-lead-organic-chemistry-fixed-') && file.endsWith('.json'));
