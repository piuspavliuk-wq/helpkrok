...
// Конфігурація для тесту "2025 рік (Eng)"
const testConfig = {
  year: 2025,
  identifier: '2025-pharmacy-eng',
  title: '2025 рік (Eng)',
  timerSeconds: 30 // 30 секунд
};

class Pharmacy2025EngScraper {
...
async function run2025EngScraper() {
  console.log('🚀 ЗАПУСКАЄМО СКРАПЕР ДЛЯ "2025 рік (Eng)" З ТАЙМЕРОМ 30 СЕКУНД...');
  console.log('');
  
  const scraper = new Pharmacy2025EngScraper(testConfig);
...
if (require.main === module) {
  run2025EngScraper().catch(console.error);
}

module.exports = { Pharmacy2025EngScraper, run2025EngScraper };
