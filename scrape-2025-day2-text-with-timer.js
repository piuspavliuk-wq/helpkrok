...
async function scrape2025Day2TextWithTimer() {
  console.log('🚀 Запуск браузера для збору 2025р 2 д (ТЕХТ) з таймером...');
...
// Запуск скрапера
scrape2025Day2TextWithTimer().catch(console.error);
