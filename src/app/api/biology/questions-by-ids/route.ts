...
export async function GET(req: NextRequest) {
  try {
    ...
    console.log('Fetching biology questions with IDs:', questionIds);
    ...
    console.log(`Found ${questions?.length || 0} biology questions`);
    
    return NextResponse.json({ questions: questions || [] });
  } catch (error) {
    console.error('Error in /api/biology/questions-by-ids:', error);
