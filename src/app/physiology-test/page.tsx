...
export default function PhysiologyTest() {
  ...
  const fetchQuestions = async () => {
    try {
      const response = await fetch('/api/physiology/questions?limit=10')
            ...
            <CardContent className="space-y-6">
              <div className="text-center">
                <p className="text-gray-600 mb-4">
                  Пройдіть тест з 10 випадкових питань з фізіології та перевірте свої знання!
                </p>
                
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                  <h3 className="font-semibold text-blue-800 mb-2">📊 Доступно питань: {questions.length}</h3>
                  <p className="text-sm text-blue-600">
                    Система випадково вибере 10 питань з питань фізіології
                  </p>
                  {session?.user?.id && (
