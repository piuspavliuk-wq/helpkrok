...
export default function SectionOrTopicPage({ params }: PageProps) {
  ...
  useEffect(() => {
    if (!section && !topic) {
      router.push('/systems/morphological-structure-vegetative-organs')
    }
  ...
  async function checkCourseAccess() {
    ...
    try {
      const response = await fetch('/api/courses/check-access?course_id=morphological-structure-vegetative-organs')
          ...
          <div className="min-h-screen bg-gradient-to-br from-blue-50 via-blue-50 to-blue-100 relative overflow-hidden">
            <div className="relative z-10">
              <div className="px-6 py-8 sm:px-8 md:px-12">
                <Link
                  href="/systems/morphological-structure-vegetative-organs"
      ...
      <AuthGuard>
        <div className="min-h-screen bg-gradient-to-br from-blue-50 via-blue-50 to-blue-100 relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <SectionContent section={section} courseTitle="Морфологічна будова вегетативних органів" faculty="pharmaceutical" />
          </div>
        </div>
      </AuthGuard>
    )
