...
const previousCourseTitle = 'Опорно-руховий апарат. Анатомія'
const previousCourseSlug = 'musculoskeletal-system'
              ...
              return (
                <div key={section.title}>
                  {isLocked ? (
                    ...
                    <Link
                      href={`/systems/respiratory-system/${section.slug}`}
