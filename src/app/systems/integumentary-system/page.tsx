...
const previousCourseTitle = 'Центральна нервова система (ЦНС) і периферична нервова система (ПНС). Органи чуття'
const previousCourseSlug = 'central-nervous-system'
        ...
        <div className="relative z-10">
          ...
          <div className="space-y-0 pb-16 md:pb-20">
            {sections.length > 0 ? (
                ...
                return (
                  <div key={section.title}>
                    {isLocked ? (
                      ...
                      <Link
                        href={`/systems/integumentary-system/${section.slug}`}
              ...
              <div className="px-6 py-8 sm:px-8 md:px-12">
                <div className="rounded-lg bg-white/70 p-8 text-center text-gray-600">
                  <p className="text-lg mb-2">Розділи курсу</p>
                  <p className="text-sm">Розділи для цього курсу готуються</p>
                </div>
              </div>
            )}
          </div>
