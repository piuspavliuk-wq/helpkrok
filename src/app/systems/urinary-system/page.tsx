...
const previousCourseTitle = 'Травна система'
const previousCourseSlug = 'digestive-system'

export default function UrinarySystemPage() {
              ...
              return (
                <div key={section.title}>
                  {isLocked ? (
                    ...
                    <Link
                      href={`/systems/urinary-system/${section.slug}`}
