...
export default function PharmaceuticalAnalysisTheoryPage() {
  ...
  async function fetchAllProgress() {
    ...
    try {
      ...
      const course = courseData.courses.find((c: { title: string }) => 
        c.title === 'Теоретичні основи фармацевтичного аналізу'
      )
  ...
  const checkCourseAccess = useCallback(async () => {
    ...
    try {
      const response = await fetch('/api/courses/check-access?course_id=pharmaceutical-analysis-theory')
          ...
          <div className="px-6 py-8 sm:px-8 md:px-12">
            <div className="space-y-4 mb-10">
              <h1 className="text-3xl font-bold text-gray-900">
                Теоретичні основи фармацевтичного аналізу
              </h1>
                ...
                return (
                  <div key={section.title}>
                    {isLocked ? (
                      ...
                      <Link
                        href={`/systems/pharmaceutical-analysis-theory/${section.slug}`}
