...
const previousCourseTitle = 'Загальний покрив (шкіра та її деривати)'
const previousCourseSlug = 'integumentary-system'
                ...
                return (
                  <div key={section.title}>
                    {isLocked ? (
                      ...
                      <Link
                        href={`/systems/musculoskeletal-system/${section.slug}`}
