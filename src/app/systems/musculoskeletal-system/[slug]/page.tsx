...
const courseTitle = 'Опорно-руховий апарат. Анатомія'
const courseSlug = 'musculoskeletal-system'
...
export default function SectionOrTopicPage({ params }: PageProps) {
  ...
  useEffect(() => {
    if (!section && !topic) {
      router.push('/systems/musculoskeletal-system')
    }
          ...
          <div className="min-h-screen bg-gradient-to-br from-blue-50 via-blue-50 to-blue-100 relative overflow-hidden">
            <div className="relative z-10">
              <div className="px-6 py-8 sm:px-8 md:px-12">
                <Link href="/systems/musculoskeletal-system" className="inline-flex items-center gap-2 text-blue-600 hover:text-blue-700 transition-colors">
        ...
        <div className="min-h-screen bg-gradient-to-br from-blue-50 via-blue-50 to-blue-100 relative overflow-hidden">
          ...
          <div className="relative z-10">
            <div className="px-[3px] py-8 md:px-6 sm:px-8 md:px-12">
              <Link href="/systems/musculoskeletal-system" className="inline-flex items-center gap-2 text-blue-600 hover:text-blue-700 transition-colors px-3 md:px-0">
                <span aria-hidden="true">&larr;</span>
                <span>Назад до розділів</span>
              </Link>
            </div>
            ...
            <div className="mx-auto max-w-[900px] space-y-8">
              ...
              <section className="bg-white border border-blue-100 shadow-xl rounded-3xl p-10">
                <div className="space-y-4 text-gray-600">
                  ...
                  <Link href="/systems/musculoskeletal-system" className="inline-flex items-center gap-2 text-blue-600 hover:text-blue-700 font-medium">
                    <span aria-hidden="true">&larr;</span>
