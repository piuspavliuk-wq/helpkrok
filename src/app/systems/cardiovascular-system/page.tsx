...
const courseSlug = 'cardiovascular-system'
const previousCourseTitle = 'Дихальна система'
const previousCourseSlug = 'respiratory-system'
              ...
              return (
                <div key={section.title}>
                  {isLocked ? (
                    ...
                    <Link
                      href={`/systems/cardiovascular-system/${section.slug}`}
