-- Вставка всіх питань з новим CSV файлу
-- Всього питань: 60
...
(
  56,
  'Виразка дванадцятипалої кишки у ділянці малої кривизни — ураження якого судинного басейну?',
  'Права шлункова',
  'Висхідна аорта',
  'Нижня брижова',
  'B',
  'Шлунково-кишкова анатомія',
  '',
  '',
  '',
  'medical'
...
(
  57,
  'Гіпертрофія лівого шлуночка при АГ — який механізм?',
  'Зниження об’єму',
  'Травма серця',
  'Інфекція',
  'A',
