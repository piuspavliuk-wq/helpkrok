...
const testConfig = {
  ...
  title: '2024р 1д',
  timerSeconds: 300 // 5 хвилин
};

class SingleTestScraper {
...
async function runSingleScraper() {
  console.log('🚀 ЗАПУСКАЄМО ОДИН СКРАПЕР З ТАЙМЕРОМ 5 ХВИЛИН...');
  console.log('');
  
  const scraper = new SingleTestScraper(testConfig);
...
if (require.main === module) {
  runSingleScraper().catch(console.error);
}

module.exports = { SingleTestScraper, runSingleScraper };
