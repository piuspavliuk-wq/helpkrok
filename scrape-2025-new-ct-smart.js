...
// Конфігурація для тесту "Нові тести з цт 2025"
const testConfig = {
  year: 2025,
  identifier: '2025-pharmacy-new-ct',
  title: 'Нові тести з цт 2025',
  timerSeconds: 30 // 30 секунд
};

class Pharmacy2025NewCTScraper {
...
async function run2025NewCTScraper() {
  console.log('🚀 ЗАПУСКАЄМО СКРАПЕР ДЛЯ "Нові тести з цт 2025" З ТАЙМЕРОМ 30 СЕКУНД...');
  console.log('');
  
  const scraper = new Pharmacy2025NewCTScraper(testConfig);
...
if (require.main === module) {
  run2025NewCTScraper().catch(console.error);
}

module.exports = { Pharmacy2025NewCTScraper, run2025NewCTScraper };
