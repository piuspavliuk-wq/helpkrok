...
class IndividualClicksScraper {
  ...
  async saveQuestions(questions, pageInfo) {
    ...
    const filename = `krok-lead-individual-clicks-${Date.now()}.json`;
...
// Основна функція
async function scrapeWithIndividualClicks(url, timerSeconds = 10) {
  const scraper = new IndividualClicksScraper();
...
if (require.main === module) {
  ...
  scrapeWithIndividualClicks(url, timerSeconds);
}

module.exports = { IndividualClicksScraper, scrapeWithIndividualClicks };
