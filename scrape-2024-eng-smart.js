...
// Конфігурація для тесту "2024 рік (Eng)"
const testConfig = {
  year: 2024,
  identifier: '2024-pharmacy-eng',
  title: '2024 рік (Eng)',
  timerSeconds: 30 // 30 секунд
};

class Pharmacy2024EngScraper {
...
async function run2024EngScraper() {
  console.log('🚀 ЗАПУСКАЄМО СКРАПЕР ДЛЯ "2024 рік (Eng)" З ТАЙМЕРОМ 30 СЕКУНД...');
  console.log('');
  
  const scraper = new Pharmacy2024EngScraper(testConfig);
...
if (require.main === module) {
  run2024EngScraper().catch(console.error);
}

module.exports = { Pharmacy2024EngScraper, run2024EngScraper };
