...
async function importOrganicChemistrySmart() {
  try {
    console.log('🚀 Початок імпорту питань з органічної хімії (розумна версія)...');
    ...
    const jsonFiles = files.filter(file => 
      file.startsWith('krok-lead-organic-chemistry-smart-') && 
      file.endsWith('.json')
    );
